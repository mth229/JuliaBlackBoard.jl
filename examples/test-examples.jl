...
"""
    ...
    ## ---- Question ----
    ## Same question with LaTeX generating an image for substition.
    ## However, this uses Markdown for non math-mode markup
    q = mt"""
# The mean
...
"""
    for xs in ((1,2,3), (4,5,6))
        ...
        question(io, NUM,
                 question_tpl(latex=File(JuliaBlackBoard.latex_to_png(str))),
                 mean((2,3,4)))
    end
